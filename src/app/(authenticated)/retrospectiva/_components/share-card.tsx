  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col px-12 pb-11 pt-14">
        {/* Lockup de marcas (mascote + Coringas ~52% sobreposto, proporção da hero) —
            canto superior direito, FORA do fluxo p/ crescer sem comprimir o miolo */}
        <div className="pointer-events-none absolute right-7 top-9 z-10">
        ...
        {/* 1. Header: texto à esquerda (o lockup fica absoluto acima, no canto direito) */}
